...
const ServerChannel = ({
    ...
    return ( 
        ...
        cn("group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition mb-1 ",
        params.channelId === channel.id && "bg-zinc-700/20 dark:bh-zinc-700")}>
        ...
        {channel.name === "general" && <Lock className=" w-4 h-4 ml-auto text-zinc-500 dark:text-zinc-400 dark:hover-zinc-300 transition"/>}
        </button>
     );
}
